...
public class FindPswActivity extends AppCompatActivity {
    ...
    //从哪个页面跳转过来的(from为security时是从设置密保界面调转过来的，否则就是从登陆界面调转过来的)
    private  String from;
            ...
            public void onClick(View v) {
                ...
                if ("security".equals(from)) {
                   ...
                   if (TextUtils.isEmpty(userName)){
                       ...
                       Toast.makeText(FindPswActivity.this, "您输入的用户名不存咋", Toast.LENGTH_SHORT).show();
                       return;
     ...
     */
    private void saveSecurity(String valicateName){
        SharedPreferences sp = getSharedPreferences("loginInfo",MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(AnalysisUtils.readLoginUserName(this)+"_security",valicateName);
        editor.commit();
    }
    /*
    ...
    private String readSecurity(String userName){
     ...
     /*
    从SharedPreferences中根据用户输入的用户名判断是否由此用户名
     */
